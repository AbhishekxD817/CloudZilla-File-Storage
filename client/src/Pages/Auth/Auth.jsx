...
import { Input, Link, Button, Card, CardBody, CardHeader, Spinner } from "@nextui-org/react";
...
function Loader() {
    return (
        <>
            <div className='min-h-screen h-full absolute top-0 left-0 w-full z-50'>
                <div className='min-h-full w-full  bg-black opacity-70 absolute top-0 left-0'></div>
                <div className='flex min-h-screen justify-center items-center z-[51]'>
                    <Spinner />
                </div>
            </div>
        </>
